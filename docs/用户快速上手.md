...
本文面向第一次使用工作台的普通用户，目标是在本地打开一个可被 Obsidian、Codex、Claude Code 使用的医学科研 AI 知识库与执行平台。
...
如果你是开发者或高级用户，也可以 clone 开发仓库后运行 `bootstrap.ps1` 自己生成工作台。
...
```text
MedicalAIKnowledgeWorkspace/workspace.code-workspace
```
